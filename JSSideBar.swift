...
class JSSideBar: NSObject, SideBarTableViewControllerDelegate {
    ...
    init(sourceView:UIView, menuItems:Array<String>, leftIcons: [String]?) {
        super.init()
        
        originView = sourceView
        sideBarTableViewController.tableData = menuItems
        animator = UIDynamicAnimator(referenceView: originView!)
        sideBarTableViewController.leftIcons = leftIcons
